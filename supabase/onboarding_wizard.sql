-- Multi-step onboarding: JSON progress + complete only at end.
-- Run in Supabase SQL Editor after workspace_onboarding_and_create.sql (or merge into that file).
...
-- -----------------------------------------------------------------------------
-- Update workspace name/slug only (does NOT finish onboarding)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Shallow-merge keys into onboarding json (owner/admin)
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Final merge + mark onboarding completed
-- -----------------------------------------------------------------------------
